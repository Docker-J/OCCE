...
router.get("/", cache({ cacheName: "occe-api", cacheControl: "max-age=60" }), getColumnsController);
router.get("/column/:id", cache({ cacheName: "occe-api", cacheControl: "max-age=60" }), getColumnController);
