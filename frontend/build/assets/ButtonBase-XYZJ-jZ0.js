...
`,j=l(`span`,{name:`MuiTouchRipple`,slot:`Root`})({overflow:`hidden`,pointerEvents:`none`,position:`absolute`,zIndex:0,top:0,right:0,bottom:0,left:0,borderRadius:`inherit`}),M=l(T,{name:`MuiTouchRipple`,slot:`Ripple`})`
  opacity: 0;
  position: absolute;
...
`,ee=h.forwardRef(function(e,t){let{center:i=!1,classes:a={},className:o,...s}=c({props:e,name:`MuiTouchRipple`}),[l,u]=h.useState([]),d=h.useRef(0),f=h.useRef(null);h.useEffect(()=>{f.current&&=(f.current(),null)},[l]);let m=h.useRef(!1),g=p(),_=h.useRef(null),v=h.useRef(null),y=h.useCallback(e=>{let{pulsate:t,rippleX:r,rippleY:i,rippleSize:o,cb:s}=e;u(e=>[...e,(0,w.jsx)(M,{classes:{ripple:n(a.ripple,E.ripple),rippleVisible:n(a.rippleVisible,E.rippleVisible),ripplePulsate:n(a.ripplePulsate,E.ripplePulsate),child:n(a.child,E.child),childLeaving:n(a.childLeaving,E.childLeaving),childPulsate:n(a.childPulsate,E.childPulsate)},timeout:D,pulsate:t,rippleX:r,rippleY:i,rippleSize:o},d.current)]),d.current+=1,f.current=s},[a]),b=h.useCallback((e={},t={},n=()=>{})=>{let{pulsate:r=!1,center:a=i||t.pulsate,fakeElement:o=!1}=t;if(e?.type===`mousedown`&&m.current){m.current=!1;return}e?.type===`touchstart`&&(m.current=!0);let s=o?null:v.current,c=s?s.getBoundingClientRect():{width:0,height:0,left:0,top:0},l,u,d;if(a||e===void 0||e.clientX===0&&e.clientY===0||!e.clientX&&!e.touches)l=Math.round(c.width/2),u=Math.round(c.height/2);else{let{clientX:t,clientY:n}=e.touches&&e.touches.length>0?e.touches[0]:e;l=Math.round(t-c.left),u=Math.round(n-c.top)}if(a)d=Math.sqrt((2*c.width**2+c.height**2)/3),d%2==0&&(d+=1);else{let e=Math.max(Math.abs((s?s.clientWidth:0)-l),l)*2+2,t=Math.max(Math.abs((s?s.clientHeight:0)-u),u)*2+2;d=Math.sqrt(e**2+t**2)}e?.touches?_.current===null&&(_.current=()=>{y({pulsate:r,rippleX:l,rippleY:u,rippleSize:d,cb:n})},g.start(80,()=>{_.current&&=(_.current(),null)})):y({pulsate:r,rippleX:l,rippleY:u,rippleSize:d,cb:n})},[i,y,g]),x=h.useCallback(()=>{b({},{pulsate:!0})},[b]),S=h.useCallback((e,t)=>{if(g.clear(),e?.type===`touchend`&&_.current){_.current(),_.current=null,g.start(0,()=>{S(e,t)});return}_.current=null,u(e=>e.length>0?e.slice(1):e),f.current=t},[g]);return h.useImperativeHandle(t,()=>({pulsate:x,start:b,stop:S}),[x,b,S]),(0,w.jsx)(j,{className:n(E.root,a.root,o),ref:v,...s,children:(0,w.jsx)(r,{component:null,exit:!0,children:l})})});function N(e){return u(`MuiButtonBase`,e)}var P=a(`MuiButtonBase`,[`root`,`disabled`,`focusVisible`]),te=e=>{let{disabled:t,focusVisible:n,focusVisibleClassName:r,suppressFocusVisible:i,classes:a}=e,o=s({root:[`root`,t&&`disabled`,n&&!i&&`focusVisible`]},N,a);return n&&!i&&r&&(o.root+=` ${r}`),o},ne=l(`button`,{name:`MuiButtonBase`,slot:`Root`})({display:`inline-flex`,alignItems:`center`,justifyContent:`center`,position:`relative`,boxSizing:`border-box`,WebkitTapHighlightColor:`transparent`,backgroundColor:`transparent`,outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:`pointer`,userSelect:`none`,verticalAlign:`middle`,MozAppearance:`none`,WebkitAppearance:`none`,textDecoration:`none`,color:`inherit`,"&::-moz-focus-inner":{borderStyle:`none`},[`&.${P.disabled}`]:{pointerEvents:`none`,cursor:`default`},"@media print":{colorAdjust:`exact`}}),F=h.forwardRef(function(e,t){let r=c({props:e,name:`MuiButtonBase`}),{action:i,centerRipple:a=!1,children:o,className:s,component:l=`button`,disabled:u=!1,disableRipple:d=!1,disableTouchRipple:p=!1,focusRipple:m=!1,focusVisibleClassName:v,focusableWhenDisabled:y,suppressFocusVisible:x=!1,internalNativeButton:C,LinkComponent:T=`a`,nativeButton:E,onBlur:D,onClick:O,onContextMenu:k,onDragLeave:A,onFocus:j,onFocusVisible:M,onKeyDown:N,onKeyUp:P,onMouseDown:F,onMouseLeave:L,onMouseUp:re,onTouchEnd:R,onTouchMove:z,onTouchStart:ie,tabIndex:B=0,TouchRippleProps:ae,touchRippleRef:oe,type:V,...H}=r,U=!!(H.href||H.to),W=!!H.formAction,G=l;G===`button`&&U&&(G=T);let K=typeof G==`string`?G===`button`:C??!1,se=E??K,q=S(),ce=f(q.ref,oe),[J,Y]=h.useState(!1);(u||x)&&J&&Y(!1);let le=g(e=>{m&&!e.repeat&&J&&e.key===` `&&q.stop(e,()=>{q.start(e)})}),ue=g(e=>{m&&e.key===` `&&J&&!e.defaultPrevented&&q.stop(e,()=>{q.pulsate(e)})}),{getButtonProps:de,rootRef:X}=b({nativeButton:se,nativeButtonProp:E,internalNativeButton:K,allowInferredHostMismatch:U||typeof G==`string`,disabled:u,type:V,hasFormAction:W,tabIndex:B,onBeforeKeyDown:le,onBeforeKeyUp:ue}),{onClick:fe,onKeyDown:pe,onKeyUp:me,...he}=de({onClick:O,onKeyDown:N,onKeyUp:P});h.useImperativeHandle(i,()=>({focusVisible:()=>{Y(!0),X.current.focus()}}),[X]);let ge=q.shouldMount&&!d&&!u;h.useEffect(()=>{J&&m&&!d&&q.pulsate()},[d,m,J,q]);let _e=I(q,`start`,F,p),ve=I(q,`stop`,k,p),ye=I(q,`stop`,A,p),be=I(q,`stop`,re,p),xe=I(q,`stop`,e=>{J&&e.preventDefault(),L&&L(e)},p),Se=I(q,`start`,ie,p),Z=I(q,`stop`,R,p),Ce=I(q,`stop`,z,p),we=I(q,`stop`,e=>{_(e.target)||Y(!1),D&&D(e)},!1),Te=g(e=>{X.current||=e.currentTarget,!x&&_(e.target)&&(Y(!0),M&&M(e)),j&&j(e)}),Q={};U&&(Q.tabIndex=u?-1:B,u&&(Q[`aria-disabled`]=u),Q.type=V);let Ee=f(t,X),$={...r,centerRipple:a,component:l,disabled:u,disableRipple:d,disableTouchRipple:p,focusRipple:m,suppressFocusVisible:x,tabIndex:B,focusVisible:J},De=te($);return(0,w.jsxs)(ne,{as:G,className:n(De.root,s),ownerState:$,onBlur:we,onClick:fe,onContextMenu:ve,onFocus:Te,onKeyDown:pe,onKeyUp:me,onMouseDown:_e,onMouseLeave:xe,onMouseUp:be,onDragLeave:ye,onTouchEnd:Z,onTouchMove:Ce,onTouchStart:Se,ref:Ee,...U?Q:he,...H,children:[o,ge?(0,w.jsx)(ee,{ref:ce,center:a,...ae}):null]})});function I(e,t,n,r=!1){return g(i=>(n&&n(i),r||e[t](i),!0))}export{_ as n,g as r,F as t};